...
"""Amplia perfis para o coordenador Desktop Experience (M10-H)."""
...
_STATEMENTS = (
    ...
    CREATE TABLE profile (
      ...
      scope         TEXT NOT NULL CHECK (
        scope IN ('game','platform','device','mode','desktop-experience')
      ),
    ...
    SELECT id,scope,kind,payload_json,priority,profile_owner FROM profile_v1
    """,
