...
def handheld_ui_contracts() -> dict[str, Any]:
    ...
    actions = [
        ...
        _action(
            "theme.import.package.inspect",
            "Examinar pacote de tema antes de importar",
            "/theme/import/package/inspect",
            service="system",
            screen="system",
            control="theme-import-package-inspect",
            schema=_schema("source", source="string"),
        ),
        _action(
            "theme.import.package.apply",
            "Importar pacote de tema SteamZero",
            "/theme/import/package/apply",
            service="system",
            screen="system",
            control="theme-import-package-apply",
            schema=_schema("source", source="string", overwrite="boolean"),
        ),
        _action(
            "theme.catalog.list",
            "Listar temas ES-DE curados",
            "/theme/catalog/list",
            service="system",
            screen="system",
            control="theme-catalog-list",
            schema=_schema(),
        ),
        _action(
            "theme.catalog.install",
            "Instalar tema curado",
            "/theme/catalog/install",
            service="system",
            screen="system",
            control="theme-catalog-install",
            schema=_schema("themeId", themeId="string", overwrite="boolean"),
        ),
        _action(
            "theme.catalog.rollback",
            "Desfazer instalação de tema",
            "/theme/catalog/rollback",
            service="system",
            screen="system",
            control="theme-catalog-rollback",
            schema=_schema("themeId", "operationId", themeId="string", operationId="string"),
        ),
        _action(
            ...
            service="system",
            screen="system",
            control="theme-catalog-uninstall",
            confirmation="explicit",
            schema=_schema("themeId", themeId="string"),
        ),
        _action(
            "theme.store.gc",
            "Recuperar espaço de assets sem dono",
            "/theme/store/gc",
            service="system",
            screen="system",
            control="theme-store-gc",
            confirmation="explicit",
        ...
        _action(
            ...
            service="system",
            screen="system",
            control="theme-import-esde-inspect",
            schema=_schema("source", source="string"),
        ),
        _action(
            "theme.import.esde.apply",
            "Importar esquema de tema ES-DE",
            "/theme/import/esde/apply",
            service="system",
            screen="system",
            control="theme-import-esde-apply",
            schema=_schema("source", source="string", scheme="string", name="string"),
        ),
        _action(
            "theme.import.retrofe.inspect",
            "Examinar cena RetroFE antes de importar",
            "/theme/import/retrofe/inspect",
            service="system",
            screen="system",
            control="theme-import-retrofe-inspect",
            schema=_schema("source", source="string"),
        ),
        _action(
            "theme.import.retrofe.apply",
            "Importar cena RetroFE compilada",
            "/theme/import/retrofe/apply",
            service="system",
            screen="system",
            control="theme-import-retrofe-apply",
            schema=_schema(
                "source",
                "layout",
                "sceneId",
        ...
        _action(
            ...
            schema=_schema("sessionId", "destination", sessionId="string", destination="string"),
            confirmation="dialog",
        ),
        _action(
            "theme.editor.export.apply",
            "Confirmar exportação do tema",
            "/theme/editor/export/apply",
            service="system",
            screen="system",
            control="theme-editor-export",
