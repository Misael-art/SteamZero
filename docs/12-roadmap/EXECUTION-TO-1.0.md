...
| 11 | Migração dos harnesses QML | **parcial** — o módulo legado handheld e os quatro probes de jornadas/inventário UI agora falham explicitamente quando Qt/SVG falta; testes independentes de `qmltestrunner` do Launcher ainda têm `skipif` | harness canônico | zero skip no gate visual | P2 | fechar GAP-G13 |
