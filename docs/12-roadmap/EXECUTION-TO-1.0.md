...
| 10 | Acessibilidade real | **parcial** — host `visualScale`, `reducedMotion` e `highContrast` chegam a consumidores; Main, Emulation, SteamGameplay, SteamDesktop, EditorialLibrary/ScreenshotRail, LauncherGamePage, ThemeCatalogPanel/ThemeSceneFullscreen, ThemeEditorPanel/ThemeStudioCanvas/SceneSurfacePreview, ColorPickerDialog, SceneRepeater/SceneText/SceneBadge, SectionNavigator/SectionMenu/LoadingOverlay/EmptyState/FeedbackNotice e quatro cartões reutilizáveis escalam tamanhos fixos; LauncherShell/LauncherMain/LauncherHome e SceneEsdeView permanecem sob ownership ativo com pixels fixos; o Resolver agora consome bindings `accessibility.*` e `fontScale`, mas a ponte do snapshot para todos os contextos e componentes reutilizáveis permanece aberta (GAP-G12/G15) | tipografia/layout | textScale, reducedMotion, highContrast consumidos de verdade em todas as superfícies | P1 | propagar contexto/helper aos componentes restantes e medir a cena completa |
