...
| 9 | Árvore de cena e texto avançado | **parcial** — `children` e round-trip v2 já existem; wrapping, elide, rich text e auto-fit ainda não estão integrados à fatia | P0-03 | children, wrapping, elide, rich text, auto-fit com gates | P1 | especificar os slices restantes |
