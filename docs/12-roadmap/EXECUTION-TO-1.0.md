...
| 10 | Acessibilidade real | **parcial** — host `visualScale`, `reducedMotion` e `highContrast` chegam a consumidores; shell principal ainda tem pixels fixos (GAP-G12/G15) | tipografia/layout | textScale, reducedMotion, highContrast consumidos de verdade em todas as superfícies | P1 | concluir escala do shell e invalidação seletiva |
