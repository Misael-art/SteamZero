...
| 9 | Árvore de cena e texto avançado | **parcial** — `children` e round-trip v2 já existem; wrapping, elide, limite de linhas e auto-fit integrados à fatia; rich text permanece adiado por segurança | P0-03 | children, wrapping, elide, rich text, auto-fit com gates | P1 | definir allowlist/sanitização de rich text e integrar ao corpus |
