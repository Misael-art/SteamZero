...
| 11 | Migração dos harnesses QML | **parcial** — o módulo legado handheld agora falha explicitamente quando Qt/SVG falta; probes adjacentes de `qmltestrunner` e inventário de UI ainda têm `skipif` | harness canônico | zero skip no gate visual | P2 | fechar GAP-G13 |
