...
| 8 | Fechar P0-03 | **parcial** — a fatia traduz 12 atributos de texto, incluindo `layer`→`zIndex`; corpus tem 388 propriedades | a42 estabilizada | 388 migradas, cobertura 100%, relatório | P1 | migrar corpus por família |
