...
| FM-26 | Dois launchers tentam assumir a sessão de jogo ou o wrapper cai | índice parcial exclusivo + PID/lifecycle persistente | segundo launch recebe E-TX-LOCKED; PID morto exige E-SESSION-INTERRUPTED e recovery explícito | Uma fonte de verdade; nenhum sucesso implícito |
