...
| G6 — plano de controle | **parcial: observação contínua e Polkit mínimo reais** | `steamzero-core` user-scoped, socket UNIX 0600, `SO_PEERCRED`, reconciliador persistente e health Polkit estão verdes; efetores mutáveis com verify/rollback continuam bloqueados |
