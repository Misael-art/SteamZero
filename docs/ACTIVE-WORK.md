...
| WS-2026-08-HOST-RELEASE-UPDATE | SZ-HOST-RELEASE-UPDATE | `codex/transactional-host-update` | `e71d9b41982de74328cd9956b447f6009cbee509` | codex-host-update | tools/release_host.py<br>tools/install_host.py<br>tests/unit/test_release_host.py<br>tests/integration/test_host_installer.py<br>docs/09-operations/RELEASE-HOST-AUTOMATION.md<br>docs/09-operations/UPDATE-AND-ROLLBACK.md | Implementar update transacional sem tocar no host real e provar recuperacao por testes com injeção de falha. |
