...
|---|---|---|---|---|---|---|
| WS-2026-08-G45-AUTOCONFIG | SZ-EMULATION-M10 | `codex/g45-custody-recovery` | `38bc1b7` | g45-autoconfig | docs/09-operations/evidence/2026-08-13-retroarch-autoconfig<br>src/steamzero/adapters/input_devices.py<br>src/steamzero/domain/retroarch_autoconfig.py<br>src/steamzero/ui/qml/ControlsProfileCard.qml<br>tests/qml/check_controls_profile_card.qml<br>tests/unit/test_input_devices.py<br>tests/unit/test_retroarch_autoconfig.py | HANDOFF 2026-08-13: branch codex/g45-custody-recovery (a partir de 38bc1b7) corrige a custodia transacional: journal de custodia durável, recovery pos-crash, rollback de operacao commitada priorizado, symlink e move seguros, EXDEV deliberado. A integracao --appendconfig da G45 ja esta provada; depois desta correcao do nucleo, a PR #78 so libera com a prova fisica com controle REAL e com a revisao confirmando crash recovery, symlink, move e cross-filesystem. |
