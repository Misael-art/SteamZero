...
| WS-2026-08-UI-FUNCTIONAL-CLOSURE | SZ-UI-DESKTOP-AUDIT | `codex/ui-ux-state-fixture-audit-clean` | `5be0aa718b0d0d0c93d1586c76ecef92cdf01d61` | ui-ux-state-fixture-clean | tests/integration/test_ui_action_inventory.py<br>tests/integration/test_ui_control_matrix.py<br>tests/unit/test_ui_audit_runner.py<br>tools/ui_action_inventory.py<br>tools/ui_action_probe.qml<br>tools/ui_audit_capture.qml<br>tools/ui_audit_runner.py<br>tools/ui_control_inventory.py<br>tools/ui_control_probe.qml<br>tools/ui_scenario_fixtures.py | Historico reconstruido sem os 5,3 MB de fixtures geradas. Cenarios de estado entregues: 574 controles, 14 cenarios, 196 exercitados (era 73). Abertos: provar estabilidade real das identidades (label e indice ainda entram na chave), identidade semantica por objectName, drawers/dialogs/jobs/recovery, revalidacao do card de plataforma e P0 visuais. Fisica com o operador. |
