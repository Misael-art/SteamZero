...
|---|---|---|---|---|---|---|
| WS-2026-08-G45-AUTOCONFIG | SZ-EMULATION-M10 | `codex/g45-autoconfig-gerenciado` | `e71d9b4` | g45-autoconfig | docs/09-operations/evidence/2026-08-13-retroarch-autoconfig<br>src/steamzero/adapters/input_devices.py<br>src/steamzero/domain/retroarch_autoconfig.py<br>src/steamzero/ui/qml/ControlsProfileCard.qml<br>tests/qml/check_controls_profile_card.qml<br>tests/unit/test_input_devices.py<br>tests/unit/test_retroarch_autoconfig.py | Repetir a prova pelo BOTAO real da UI ('Abrir emulador' / 'Jogar') com um controle FISICO que tenha autoconfig empacotado. O overlay ja chega aos dois caminhos de lancamento e as tres janelas transacionais estao fechadas; falta so o hardware, que e do operador. |
