...
| SZ-HOST-RELEASE-UPDATE | Atualizacao transacional e recuperavel do host | verified-dev | complete | feature-branch | dev | unknown | not-packaged | Integrar a branch, aguardar CI verde e executar VM install-rollback-roll-forward antes de qualquer uso no host. |
