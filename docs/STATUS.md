...
| SZ-EMULATION-M10 | Ciclo transacional de emuladores Flatpak | verified-vm | partial | feature-branch | vm | degraded | installed | Provar a descoberta automatica com um CONTROLE FISICO que tenha autoconfig empacotado. A integracao --appendconfig ja esta provada ponta a ponta e chega aos botoes reais, mas o pad do uinput nao recebe symlink -event-joystick (onde a descoberta procura) e o pad interno deste Deck nao tem autoconfig. |
