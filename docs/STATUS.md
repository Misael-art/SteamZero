...
| SZ-AURA-LAUNCHER | AURA Launcher — biblioteca fullscreen e lancamento | planned | planned | isolated | none | unknown | not-packaged | Renderizar a home fullscreen consumindo este mapa de foco, com navegacao real por controle, e so entao falar em baseline visual. |
