...
| SZ-THEME-ENGINE | Theme Engine — cenas e efeitos declarativos | partial | partial | integrated | unit | degraded | installed | Avançar widgets allowlisted do Launcher (clock, recently played, statistics). Medição física permanece na release instalada identificada. |
