...
| SZ-UI-DESKTOP-AUDIT | UI Desktop — auditoria visual e jornadas P0/P1 | verified-dev | partial | feature-branch | dev | degraded | not-packaged | Medido em 2026-08-13 com 14 cenarios: 574 controles em 12 superficies; 17 roteados, 166 locais, 13 bloqueados com motivo, 378 nao sondados. 196 exercitados contra 73 antes. Zero no-op silencioso, zero sem rota, zero bloqueado mudo, zero acionavel sem nome acessivel. Somente 'sync' esta integralmente sondada. A identidade de controle ainda depende de rotulo e indice: nao pode ser chamada de estavel ate os testes de estabilidade passarem. Abertos: identidade semantica, drawers/dialogs/jobs/recovery, revalidacao do card de plataforma e P0 visuais. |
