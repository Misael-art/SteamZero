...
| SZ-THEME-ENGINE | Theme Engine — cenas e efeitos declarativos | partial | partial | integrated | unit | degraded | installed | Avançar highlight central e transparência por idle/foco. Medição física permanece na release instalada identificada. |
