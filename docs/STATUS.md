...
| SZ-THEME-ENGINE | Theme Engine — cenas e efeitos declarativos | verified-hw | partial | integrated | hw | degraded | installed | Construir release do commit verde e validar fisicamente invert/hue rotate e a convergencia do instalador na instalacao governada. |
