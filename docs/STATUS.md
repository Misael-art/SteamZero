...
| SZ-THEME-ENGINE | Theme Engine — cenas e efeitos declarativos | partial | partial | integrated | unit | degraded | installed | Fechar gates e CI do slice asset-unico; obter autorizacao com release exata para publicar, instalar e produzir evidencia fisica. Enquanto essa dependencia externa persistir, iniciar a onda de cache adaptativo. |
| SZ-THEME-STUDIO | Theme Studio — autoria visual de temas | partial | partial | integrated | unit | degraded | installed | Fechar GAP-G39 e entregar o primeiro slice visual canvas-arvore-inspector ligado ao scene graph da Theme Engine. |
