...
| SZ-UI-DESKTOP-AUDIT | UI Desktop — auditoria visual e jornadas P0/P1 | verified-dev | partial | feature-branch | dev | degraded | not-packaged | Medido em 2026-08-13: 288 controles em 12 superficies; 10 roteados, 49 locais, 14 bloqueados com motivo, 215 nao sondados (invisiveis no estado offline). Zero no-op silencioso, zero sem rota, zero bloqueado mudo. 7 defeitos encontrados e 7 corrigidos. 117 contratos ainda NAO COBERTOS por esta auditoria (nao sao orfaos: 1 de 17 superficies inventariada pela sonda de acoes). Falta tornar os controles invisiveis sondaveis por fixture de estado, cobrir dialogs/recovery/jobs e so entao atacar os P0 visuais (DarkButton, capas, Home). |
