...
| SZ-THEME-ENGINE | Theme Engine — cenas e efeitos declarativos | verified-hw | partial | integrated | hw | degraded | installed | Corrigir os tres defeitos abertos encontrados na validacao fisica: capability de invert/hue-rotate, sinal de fallback no no visual e restart do daemon no instalador. |
