...
| SZ-EMULATION-ENHANCEMENTS | Melhorias por jogo agnósticas de plataforma | planned | planned | feature-branch | none | unknown | not-packaged | Onda 1: leitores de identidade por plataforma e bump do schema known-good-profile v1->v2 com migração. |
