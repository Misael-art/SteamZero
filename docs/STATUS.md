...
| SZ-THEME-ENGINE | Theme Engine — cenas e efeitos declarativos | partial | partial | integrated | unit | degraded | installed | Iniciar states, timeline e transições declarativas. Release e evidência física dos slices anteriores aguardam identificação da release exata. |
