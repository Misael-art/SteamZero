...
| SZ-THEME-ENGINE | Theme Engine — cenas e efeitos declarativos | partial | partial | integrated | unit | degraded | installed | Implementar o primeiro slice asset-unico para recolor, silhueta e contorno fino/grosso, com fixture licenciada e prova GPU. |
