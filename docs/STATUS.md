...
| SZ-UI-DESKTOP-AUDIT | UI Desktop — auditoria visual e jornadas P0/P1 | verified-dev | partial | feature-branch | dev | degraded | not-packaged | Confirmacao por clique Qt, deduplicacao, refresh e recovery pela bridge loopback foram provados. Cancelamento e repeticao exercitam o sinal dos controles reais do task drawer; o executor offscreen ainda nao injeta ponteiro no Popup do Drawer, portanto essa entrada fisica nao e declarada provada. A auditoria continua incompleta: 378 controles not-probed, dialogs/drawers restantes, card de plataforma e P0 visuais. Baseline de 14 cenários: 574 controles, 80 identidades explícitas, 494 fallback, 0 colisões. |
