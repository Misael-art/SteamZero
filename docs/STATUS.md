...
| SZ-AURA-LAUNCHER | AURA Launcher — biblioteca fullscreen e lancamento | planned | planned | isolated | none | unknown | not-packaged | Executar o ciclo fisico pelo caminho corrigido: home, pagina, launch_game com validacao real, retorno ao foco de saida e troca de plataforma. |
