...
| SZ-THEME-ENGINE | Theme Engine — cenas e efeitos declarativos | partial | partial | integrated | unit | degraded | installed | Avançar componentes do Launcher declarativos. Medição física permanece na release instalada identificada. |
