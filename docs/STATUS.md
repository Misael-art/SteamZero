...
| SZ-THEME-ENGINE | Theme Engine — cenas e efeitos declarativos | partial | partial | integrated | unit | degraded | installed | Avançar panels, cards e modals semânticos. Medição física permanece na release instalada identificada. |
