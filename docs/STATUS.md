...
| SZ-AURA-LAUNCHER | AURA Launcher — biblioteca fullscreen e lancamento | planned | planned | isolated | none | unknown | not-packaged | Pagina de jogo e o par lancamento/retorno ao mesmo contexto — os itens 2 e 4 da Definition of Done; so entao um shell que instancie a home fora do harness. |
