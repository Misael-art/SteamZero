...
| SZ-AURA-LAUNCHER | AURA Launcher — biblioteca fullscreen e lancamento | planned | planned | isolated | none | unknown | not-packaged | Entry point que abra o shell como processo, alimentado por read model real, e empacota-lo para a primeira evidencia fisica do Launcher numa release instalada. |
