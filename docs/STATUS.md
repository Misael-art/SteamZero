...
| SZ-THEME-ENGINE | Theme Engine — cenas e efeitos declarativos | verified-hw | partial | integrated | hw | degraded | installed | Re-rodar o CI do PR #85 (job 3.11 pendurou no apt-get; timeouts ja adicionados), merge em main e instalar para provar invert/hue e a convergencia. |
