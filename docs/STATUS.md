...
| SZ-AURA-LAUNCHER | AURA Launcher — biblioteca fullscreen e lancamento | planned | planned | isolated | none | unknown | not-packaged | Montar o shell que instancia home, pagina e retorno num processo so, e instalar para obter a primeira evidencia fisica do Launcher. |
