...
| SZ-THEME-ENGINE | Theme Engine — cenas e efeitos declarativos | partial | partial | integrated | unit | degraded | installed | Avançar badges, labels e glyphs semânticos. Medição física permanece na release instalada identificada. |
