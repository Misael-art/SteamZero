...
| SZ-THEME-ENGINE | Theme Engine — cenas e efeitos declarativos | partial | partial | integrated | unit | degraded | installed | Iniciar componentes Launcher, OSD e save gallery por contratos. Release e evidência física dos slices anteriores aguardam identificação da release exata. |
