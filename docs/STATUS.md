...
| SZ-THEME-STUDIO | Theme Studio — autoria visual de temas | partial | partial | integrated | unit | degraded | installed | Acrescentar timeline de autoria e capturar evidência física do canvas na próxima release instalada. |
