...
| SZ-UI-DESKTOP-AUDIT | UI Desktop — auditoria visual e jornadas P0/P1 | verified-dev | partial | feature-branch | dev | degraded | not-packaged | Confirmacao, cancelamento e repeticao por cliques Qt, deduplicacao com resposta pendente controlada, estados carregando/vazio/erro do task drawer e recovery em sucesso/falha foram provados pela bridge loopback. A auditoria continua incompleta: 378 controles not-probed, handheld drawer e demais estados de dialogs/credenciais, card de plataforma e P0 visuais. Baseline recalculada de 14 cenarios: 574 controles, 80 identidades explicitas, 494 fallback, 0 colisoes, 553 multi-cenario e 21 de cenario unico. |
