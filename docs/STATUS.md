...
| SZ-THEME-ENGINE | Theme Engine — cenas e efeitos declarativos | partial | partial | integrated | unit | degraded | installed | Iniciar extração de cores, glass e effect nodes por tiers. Release e evidência física dos slices de receitas, cache e layouts aguardam identificação da release exata. |
