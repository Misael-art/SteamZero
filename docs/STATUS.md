...
| SZ-THEME-ENGINE | Theme Engine — cenas e efeitos declarativos | partial | partial | integrated | unit | degraded | installed | Avançar stack/flow declarativos. Medição física permanece na release instalada identificada. |
