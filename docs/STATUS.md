...
| SZ-AURA-LAUNCHER | AURA Launcher — biblioteca fullscreen e lancamento | planned | planned | isolated | none | unknown | not-packaged | Lancar um processo real e voltar, com o shell instalado, para so entao falar em evidencia fisica do vertical. |
