...
| SZ-HOST-RELEASE-UPDATE | Atualizacao transacional e recuperavel do host | partial | partial | feature-branch | none | unknown | not-packaged | Implementar o controlador update, failure injection e documentar a certificacao fisica separada. |
