...
| SZ-UI-DESKTOP-AUDIT | UI Desktop — auditoria visual e jornadas P0/P1 | verified-dev | partial | feature-branch | dev | degraded | not-packaged | Identidade: 80 explicitas (Home + cards de plataforma + linhas de emulador) e 470 no fallback estrutural, zero colisoes. As explicitas provadamente sobrevivem a troca de rotulo e a irmaos entrando e saindo; as do fallback NAO tem essa garantia e a matriz publica quantas sao. Matriz com 3 cenarios: 550 controles, 275 vistos em mais de um cenario. Abertos: identidade explicita nas demais superficies, drawers/dialogs/jobs/recovery, revalidacao do card de plataforma e P0 visuais. |
