...
| SZ-UI-DESKTOP-AUDIT | UI Desktop — auditoria visual e jornadas P0/P1 | verified-dev | partial | feature-branch | dev | degraded | not-packaged | QML-KEY-INJECTION-001 fechado: QuickTest Qt 6 com raiz Item hospeda Main e executa Escape/Tab reais, incluindo recovery NoAutoClose, retorno de foco e focus trap. A auditoria ainda não está completa: faltam confirmação por bridge, clique repetido, jobs/task drawer e recovery ponta a ponta. Baseline de 14 cenários permanece: 574 controles, 378 not-probed, 80 identidades explícitas, 494 fallback, 0 colisões. |
