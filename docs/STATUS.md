...
| SZ-AURA-LAUNCHER | AURA Launcher — biblioteca fullscreen e lancamento | planned | planned | isolated | none | unknown | not-packaged | Instalar a release e capturar home, pagina e retorno com um jogo de Switch lancado de verdade — os emuladores de Switch ja estao funcionais no host. |
