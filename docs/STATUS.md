...
| SZ-AURA-LAUNCHER | AURA Launcher — biblioteca fullscreen e lancamento | planned | planned | isolated | none | unknown | not-packaged | Executar a instalacao automatica pelo lifecycle e rodar o ciclo fisico: tela cheia, lancamento, execucao, save, fechamento, troca de sistema e retorno. |
