...
| SZ-UI-DESKTOP-AUDIT | UI Desktop — auditoria visual e jornadas P0/P1 | verified-dev | partial | feature-branch | dev | degraded | not-packaged | Baseline de 14 cenarios reconfirmada por medicao: 574 controles, 80 identidades explicitas, 494 fallback, 0 colisoes, 553 vistos em multiplos cenarios, 21 em um so, 378 not-probed. A passagem anterior publicou identidade de 3 cenarios (550/80/470) na mesma tabela que cobertura de 14: corrigido. Dialogos: 6 jornadas completas provadas, 2 defeitos corrigidos (modal abria sem foco; Escape deixava plano pendurado). Abertos: drawers, jobs, recovery alem da abertura, credenciais por estado, revalidacao do card de plataforma e P0 visuais. |
