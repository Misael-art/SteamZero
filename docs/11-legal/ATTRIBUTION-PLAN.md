...
8. Todo asset binário/SVG novo no repositório atualiza `ASSET-INVENTORY.md` (hash + licença + origem) no mesmo PR. G7 permanece aberta até inventário regenerado no tip final M10+M11 (rascunho 2026-08-10 é só preparatório).
