...
| SZ-AGG-DOMAIN | 99 | 0 | 0 | none | custodia declarada; nenhuma capacidade provada |
...
| SZ-AGG-TESTS | 403 | 0 | 0 | none | custodia declarada; nenhuma capacidade provada |
...
| SZ-UI-DESKTOP-AUDIT | 361 | 36 | 23 | dev |  |
| SZ-UI-PACKAGED-ICONS | 51 | 4 | 2 | unit |  |
| SZ-V2-HARMONIZED-FUNCTIONAL-RELEASE | 2 | 1 | 0 | none |  |

Arquivos em `src/`: **552**. Sob agregador apenas, sem item de capacidade: **287** (51%). Esse numero e o tamanho real do runtime que tem dono declarado e nenhuma capacidade provada; ele deve cair conforme recortes viram itens proprios, e subir e sinal de codigo novo entrando sem capacidade declarada.
