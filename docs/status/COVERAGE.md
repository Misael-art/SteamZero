...
|---|---|---|---|---|---|
| SZ-AGG-ADAPTERS | 123 | 0 | 0 | none | custodia declarada; nenhuma capacidade provada |
...
| SZ-AGG-TESTS | 482 | 0 | 0 | none | custodia declarada; nenhuma capacidade provada |
...
| SZ-PLATFORM-PS5-CATALOG | 14 | 9 | 7 | unit |  |
...
Arquivos em `src/`: **604**. Sob agregador apenas, sem item de capacidade: **282** (46%). Esse numero e o tamanho real do runtime que tem dono declarado e nenhuma capacidade provada; ele deve cair conforme recortes viram itens proprios, e subir e sinal de codigo novo entrando sem capacidade declarada.
