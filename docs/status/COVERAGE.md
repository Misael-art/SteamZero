...
| SZ-AGG-TESTS | 298 | 0 | 0 | none | custodia declarada; nenhuma capacidade provada |
| SZ-AGG-TOOLS | 30 | 0 | 0 | none | custodia declarada; nenhuma capacidade provada |
| SZ-AURA-LAUNCHER | 12 | 2 | 2 | none |  |
...
Arquivos em `src/`: **472**. Sob agregador apenas, sem item de capacidade: **313** (66%). Esse numero e o tamanho real do runtime que tem dono declarado e nenhuma capacidade provada; ele deve cair conforme recortes viram itens proprios, e subir e sinal de codigo novo entrando sem capacidade declarada.
