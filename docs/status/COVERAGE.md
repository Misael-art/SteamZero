...
| SZ-AGG-TESTS | 450 | 0 | 0 | none | custodia declarada; nenhuma capacidade provada |
...
| SZ-EMULATION-ENHANCEMENTS | 24 | 10 | 10 | unit |  |
| SZ-EMULATION-LONG-OPERATIONS | 28 | 20 | 14 | hw |  |
...
| SZ-LIBRARY-CANONICAL | 89 | 11 | 8 | dev |  |
...
| SZ-MEDIA-PROVIDER-PLATFORM-FILTER | 10 | 3 | 3 | unit |  |
| SZ-MEDIA-SCRAPING | 29 | 7 | 7 | unit |  |
| SZ-ONLINE-P2P | 37 | 2 | 1 | none |  |
| SZ-PLATFORM-CORE-PER-SYSTEM | 78 | 5 | 4 | unit |  |
| SZ-PLATFORM-GAMECUBE-CATALOG | 4 | 0 | 0 | none | sem evidencia registrada |
...
| SZ-UI-DESKTOP-AUDIT | 390 | 42 | 27 | dev |  |
| SZ-UI-PACKAGED-ICONS | 53 | 5 | 3 | unit |  |
| SZ-V2-HARMONIZED-FUNCTIONAL-RELEASE | 2 | 1 | 0 | none |  |

Arquivos em `src/`: **571**. Sob agregador apenas, sem item de capacidade: **285** (49%). Esse numero e o tamanho real do runtime que tem dono declarado e nenhuma capacidade provada; ele deve cair conforme recortes viram itens proprios, e subir e sinal de codigo novo entrando sem capacidade declarada.
