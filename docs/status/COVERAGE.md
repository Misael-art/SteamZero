...
| SZ-AGG-DOMAIN | 91 | 0 | 0 | none | custodia declarada; nenhuma capacidade provada |
...
| SZ-EMULATION-LONG-OPERATIONS | 6 | 1 | 1 | unit |  |
...
Arquivos em `src/`: **487**. Sob agregador apenas, sem item de capacidade: **294** (60%). Esse numero e o tamanho real do runtime que tem dono declarado e nenhuma capacidade provada; ele deve cair conforme recortes viram itens proprios, e subir e sinal de codigo novo entrando sem capacidade declarada.
