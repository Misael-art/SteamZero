...
|---|---|---|---|---|---|
| SZ-AGG-ADAPTERS | 115 | 0 | 0 | none | custodia declarada; nenhuma capacidade provada |
...
| SZ-AGG-TESTS | 456 | 0 | 0 | none | custodia declarada; nenhuma capacidade provada |
...
| SZ-AURA-SESSION-OSD | 2 | 1 | 1 | unit |  |
...
Arquivos em `src/`: **572**. Sob agregador apenas, sem item de capacidade: **287** (50%). Esse numero e o tamanho real do runtime que tem dono declarado e nenhuma capacidade provada; ele deve cair conforme recortes viram itens proprios, e subir e sinal de codigo novo entrando sem capacidade declarada.
