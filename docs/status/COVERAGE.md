...
| SZ-AGG-DOMAIN | 119 | 0 | 0 | none | custodia declarada; nenhuma capacidade provada |
...
| SZ-AGG-TESTS | 489 | 0 | 0 | none | custodia declarada; nenhuma capacidade provada |
...
| SZ-UI-DESKTOP-AUDIT | 406 | 44 | 29 | dev |  |
| SZ-UI-PACKAGED-ICONS | 57 | 4 | 2 | unit |  |
| SZ-V2-HARMONIZED-FUNCTIONAL-RELEASE | 2 | 1 | 0 | none |  |

Arquivos em `src/`: **610**. Sob agregador apenas, sem item de capacidade: **272** (44%). Esse numero e o tamanho real do runtime que tem dono declarado e nenhuma capacidade provada; ele deve cair conforme recortes viram itens proprios, e subir e sinal de codigo novo entrando sem capacidade declarada.
