...
| SZ-THEME-ENGINE | 56 | 23 | 23 | unit |  |
| SZ-THEME-STUDIO | 12 | 7 | 7 | unit |  |
| SZ-UI-DESKTOP-AUDIT | 220 | 1 | 1 | dev |  |

Arquivos em `src/`: **466**. Sob agregador apenas, sem item de capacidade: **313** (67%). Esse numero e o tamanho real do runtime que tem dono declarado e nenhuma capacidade provada; ele deve cair conforme recortes viram itens proprios, e subir e sinal de codigo novo entrando sem capacidade declarada.
