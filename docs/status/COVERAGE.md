...
| SZ-AGG-DOMAIN | 87 | 0 | 0 | none | custodia declarada; nenhuma capacidade provada |
...
| SZ-AGG-SCHEMAS | 46 | 0 | 0 | none | custodia declarada; nenhuma capacidade provada |
| SZ-AGG-SERVICE-API | 11 | 0 | 0 | none | custodia declarada; nenhuma capacidade provada |
| SZ-AGG-TESTS | 293 | 0 | 0 | none | custodia declarada; nenhuma capacidade provada |
...
| SZ-THEME-ENGINE | 56 | 20 | 20 | unit |  |
| SZ-THEME-STUDIO | 12 | 7 | 7 | unit |  |
| SZ-UI-DESKTOP-AUDIT | 219 | 1 | 1 | dev |  |

Arquivos em `src/`: **465**. Sob agregador apenas, sem item de capacidade: **313** (67%). Esse numero e o tamanho real do runtime que tem dono declarado e nenhuma capacidade provada; ele deve cair conforme recortes viram itens proprios, e subir e sinal de codigo novo entrando sem capacidade declarada.
