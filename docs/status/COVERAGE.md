...
Arquivos em `src/`: **612**. Sob agregador apenas, sem item de capacidade: **270** (44%). Esse numero e o tamanho real do runtime que tem dono declarado e nenhuma capacidade provada; ele deve cair conforme recortes viram itens proprios, e subir e sinal de codigo novo entrando sem capacidade declarada.
